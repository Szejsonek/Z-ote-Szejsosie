const categories = [
  { id:"szejson_activity", name:"Szejson Activity", type:"video", items:[
    ...
    {id:"sa2", title:"Szejson moment 2", src:"clips/clip1.mp4"}
  ]},
  { id:"best_scream", name:"Najlepszy Krzyk", type:"video", items:[
    {id:"krzyk1", title:"Krzyk level 100", src:"clips/clip1.mp4"},
    {id:"krzyk2", title:"Krzyk ultimate", src:"clips/clip1.mp4"}
  ]},
  { id:"rage", name:"Rage", type:"video", items:[
    {id:"rage1", title:"Rage quit", src:"clips/clip1.mp4"},
    {id:"rage2", title:"Total rage", src:"clips/clip1.mp4"}
  ]},
